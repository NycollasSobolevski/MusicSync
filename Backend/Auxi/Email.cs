...
public static class SendEmail
{
    ...
    public static void SendEmailRecoveryPassword(string userEmail, string username, string bodyCotent) {
        MailMessage mailMessage = new MailMessage();
        mailMessage.From = new MailAddress(emailDomain);
    ...
    private static string GenerateEmailRecoveryPasswordBody (string token, string username) {
